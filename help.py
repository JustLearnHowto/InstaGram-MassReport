...
${Fore.GREEN}============================== HELP  ==============================
    ...
    if (int(que_ans)==1):
        ...
        To buy proxies go to https://t.me/HacksXploit and ask proxy.
        ...
        For more help you can directly contact me on https://t.me/HacksXploit
        Or you can report bugs at https://t.me/HacksXploit
        ...
        ''')
        help_msg()
        webbrowser.open('https://t.me/HacksXploit')
    elif(int(que_ans)==4):
        clearConsole()
